<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <head>
	 ...
	 <div id="header">
<div class="row-1">
<div class="fleft"><a href="index.jsp">Movie <span style="color:red">World</span></a></div>
          <ul>    
...
<table width="100%">
	...
	<tr><td>
		...
		<td id="databar">
			<p>We kindly request you to don't pay on some random mail.</p>
                        <p>Terms and conditions apply on all the transactions.</p>
                        <p>Any unprofessional behavior leading to break the rules will be treated legally. </p></td>
		</td></tr>
	</table></td></tr>
</table>
